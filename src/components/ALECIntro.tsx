...
const capabilities = [
  {
    ...
    description: 'ALEC doesn\'t wait for instructions. It monitors, decides, and acts on your behalf.',
    icon: (
  ...
  },
  {
    ...
    description: 'Learns your business rules, brand voice, customer history. Retains context across every interaction.',
    icon: (
  ...
  },
  {
    ...
    description: 'Lives in your email, Slack, WhatsApp, CRM -- wherever your business communicates.',
    icon: (
  ...
  },
  {
    ...
    description: 'Self-hosted option. Your data never leaves your infrastructure. Private skills repository.',
    icon: (
  ...
  },
  {
    ...
    description: 'Gets smarter every week. We optimize agent logic based on real performance data.',
    icon: (
      <svg className="w-8 h-8 text-brand-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center mb-20">
          ...
          <div className="reveal stagger-1">
            <p className="text-2xl md:text-3xl text-slate-300/80 max-w-4xl mx-auto leading-relaxed">
              Artificial Learning Execution Client. Not an assistant -- an operator.
            </p>
          </div>
        </div>
