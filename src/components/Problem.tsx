  ...
  const problems = [
    {
      ...
      description: "Every second of delay costs you 7% in conversions. Your competitors' faster sites are stealing your customers right now.",
    ...
    },
    {
      ...
      stat: 'Mobile users are 5× more likely to bounce from unoptimized sites',
    },
    {
      icon: (
        <svg className="w-8 h-8 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="problem" ref={sectionRef} className="py-28 md:py-36 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <div className="reveal">
            <h2 className="section-heading mb-6">
              <span className="gradient-text-warm">Is your website</span>
              <br />
        ...
        <div className="reveal grid grid-cols-3 gap-8 mb-20 max-w-3xl mx-auto">
          <AnimatedStat value={53} suffix="%" label="Bounce rate on slow sites" />
          <AnimatedStat value={7} suffix="%" label="Conversion loss per second" />
          <AnimatedStat value={21} suffix="%" label="Revenue lost to poor integration" />
        </div>
